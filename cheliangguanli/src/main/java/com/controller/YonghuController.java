    ...
    */
    ...
    public R save(@RequestBody YonghuEntity yonghu, HttpServletRequest request){
        ...
        Wrapper<YonghuEntity> queryWrapper = new EntityWrapper<YonghuEntity>()
            ...
            .eq("zhunjia_types", yonghu.getZhunjiaTypes())
            .eq("jiashizhenghao", yonghu.getJiashizhenghao())
            ;
...
//                            yonghuEntity.setZhunjiaTypes(Integer.valueOf(data.get(0)));   //准驾车型 要改的
//                            yonghuEntity.setJiashizhenghao(data.get(0));                    //驾驶证 要改的
//                            yonghuEntity.setYonghuContent("");//照片
