...
public class ShigudengjiView extends ShigudengjiEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 事故类型的值
		*/
		private String shigudengjiValue;
		/**
		* 责任方的值
		*/
		private String zerenValue;
	...
	public ShigudengjiView(ShigudengjiEntity shigudengjiEntity) {
		try {
			...
			* 获取： 事故类型的值
			*/
			public String getShigudengjiValue() {
				return shigudengjiValue;
			}
			/**
			* 设置： 事故类型的值
			*/
			public void setShigudengjiValue(String shigudengjiValue) {
				this.shigudengjiValue = shigudengjiValue;
			}
			/**
			* 获取： 责任方的值
			*/
			public String getZerenValue() {
				return zerenValue;
			}
			/**
			* 设置： 责任方的值
			*/
			public void setZerenValue(String zerenValue) {
				this.zerenValue = zerenValue;
			}
