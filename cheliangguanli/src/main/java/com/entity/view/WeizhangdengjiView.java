...
public class WeizhangdengjiView extends WeizhangdengjiEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 违章类型的值
		*/
		private String weizhangdengjiValue;
	...
	public WeizhangdengjiView(WeizhangdengjiEntity weizhangdengjiEntity) {
		try {
			...
			* 获取： 违章类型的值
			*/
			public String getWeizhangdengjiValue() {
				return weizhangdengjiValue;
			}
			/**
			* 设置： 违章类型的值
			*/
			public void setWeizhangdengjiValue(String weizhangdengjiValue) {
				this.weizhangdengjiValue = weizhangdengjiValue;
			}
